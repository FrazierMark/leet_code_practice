class Solution:
	def sortSentence(self, s: str) -> str:
		...
		sentence = " ".join([dic[i] for i in sorted(dic.keys())])
		return sentence
...
#Steps
# create dictionary
# Key = index int(word[-1]), Value = word[:-1] (copy everything except last char)
# join 
...
# Given a shuffled sentence s containing no more than
